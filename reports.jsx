// screens/rent-roll.jsx — collection only: who's paid, who hasn't.
// All dollar analysis (net, carrying, P&L) lives on the Rental P&L page.
    ...
    <div>
      <div className="section-h">
        ...
        <div className="row gap-10 items-center">
          <a onClick={() => nav('/rental-pnl')} className="small" style={{cursor: 'pointer'}}>Money analysis → Rental P&L</a>
          <Segmented
            value={view}
